...
-- File created: Sun Apr  2 17:52:59 2023
...
begin
	...
	forkC_3_clk <= clk;
	forkC_3_rst <= rst;
	cst_1_pValidArray_0 <= '1';
	forkC_3_nReadyArray_0 <= '1';
	...
	cst_2_pValidArray_0 <= '1';
	forkC_3_nReadyArray_2 <= '1';
	cst_2_dataInArray_0 <= "00000000000000000000000000000001";
	cst_3_pValidArray_0 <= '1';
	forkC_3_nReadyArray_3 <= '1';
...
phi_0: entity work.gian_mux(arch) generic map (3,1,32,32,1,5)
port map (
	clk => phi_0_clk,
	rst => phi_0_rst,
...
phi_1: entity work.gian_mux(arch) generic map (3,1,32,32,1,5)
port map (
	clk => phi_1_clk,
	rst => phi_1_rst,
...
phiC_2: entity work.gian_mux(arch) generic map (3,1,1,1,1,5)
port map (
	clk => phiC_2_clk,
	rst => phiC_2_rst,
