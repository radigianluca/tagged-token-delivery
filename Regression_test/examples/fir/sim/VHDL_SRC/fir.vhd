...
-- File created: Thu May  4 13:06:08 2023
...
architecture behavioral of fir is 
	...
	signal fifo_0_rst : std_logic;
	signal fifo_0_dataInArray_0 : std_logic_vector(31 downto 0);
	signal fifo_0_pValidArray_0 : std_logic;
	signal fifo_0_readyArray_0 : std_logic;
	signal fifo_0_nReadyArray_0 : std_logic;
	signal fifo_0_validArray_0 : std_logic;
	signal fifo_0_dataOutArray_0 : std_logic_vector(31 downto 0);

	signal fifo_1_clk : std_logic;
	signal fifo_1_rst : std_logic;
	signal fifo_1_dataInArray_0 : std_logic_vector(31 downto 0);
	signal fifo_1_pValidArray_0 : std_logic;
	signal fifo_1_readyArray_0 : std_logic;
	signal fifo_1_nReadyArray_0 : std_logic;
	signal fifo_1_validArray_0 : std_logic;
	signal fifo_1_dataOutArray_0 : std_logic_vector(31 downto 0);

	signal fifo_6_clk : std_logic;
	signal fifo_6_rst : std_logic;
	signal fifo_6_dataInArray_0 : std_logic_vector(31 downto 0);
	signal fifo_6_pValidArray_0 : std_logic;
	signal fifo_6_readyArray_0 : std_logic;
	signal fifo_6_nReadyArray_0 : std_logic;
	signal fifo_6_validArray_0 : std_logic;
	signal fifo_6_dataOutArray_0 : std_logic_vector(31 downto 0);
...
begin
	...
	fifo_1_pValidArray_0 <= fork_2_validArray_3;
	fork_2_nReadyArray_3 <= fifo_1_readyArray_0;
	fifo_1_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_2_dataOutArray_3),fifo_1_dataInArray_0'length));
	fifo_0_pValidArray_0 <= fork_2_validArray_4;
	fork_2_nReadyArray_4 <= fifo_0_readyArray_0;
	fifo_0_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_2_dataOutArray_4),fifo_0_dataInArray_0'length));
	...
	fifo_6_pValidArray_0 <= fork_4_validArray_2;
	fork_4_nReadyArray_2 <= fifo_6_readyArray_0;
	fifo_6_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_4_dataOutArray_2),fifo_6_dataInArray_0'length));
	...
	fifo_0_clk <= clk;
	fifo_0_rst <= rst;
	phi_20_pValidArray_0 <= fifo_0_validArray_0;
	fifo_0_nReadyArray_0 <= phi_20_readyArray_0;
	phi_20_dataInArray_0 <= std_logic_vector (resize(unsigned(fifo_0_dataOutArray_0),phi_20_dataInArray_0'length));

	fifo_1_clk <= clk;
	fifo_1_rst <= rst;
	phi_19_pValidArray_0 <= fifo_1_validArray_0;
	fifo_1_nReadyArray_0 <= phi_19_readyArray_0;
	phi_19_dataInArray_0 <= std_logic_vector (resize(unsigned(fifo_1_dataOutArray_0),phi_19_dataInArray_0'length));

	fifo_6_clk <= clk;
	fifo_6_rst <= rst;
	branch_2_pValidArray_1 <= fifo_6_validArray_0;
	fifo_6_nReadyArray_0 <= branch_2_readyArray_1;
	branch_2_dataInArray_1 <= not std_logic_vector (resize(unsigned(fifo_6_dataOutArray_0),branch_0_dataInArray_1'length));
...
fifo_0: entity work.transpFIFO(arch) generic map (1,1,32,32,3)
port map (
	clk => fifo_0_clk,
	rst => fifo_0_rst,
	dataInArray(0) => fifo_0_dataInArray_0,
	pValidArray(0) => fifo_0_pValidArray_0,
	readyArray(0) => fifo_0_readyArray_0,
	nReadyArray(0) => fifo_0_nReadyArray_0,
	validArray(0) => fifo_0_validArray_0,
	dataOutArray(0) => fifo_0_dataOutArray_0
);

fifo_1: entity work.transpFIFO(arch) generic map (1,1,32,32,3)
port map (
	clk => fifo_1_clk,
	rst => fifo_1_rst,
	dataInArray(0) => fifo_1_dataInArray_0,
	pValidArray(0) => fifo_1_pValidArray_0,
	readyArray(0) => fifo_1_readyArray_0,
	nReadyArray(0) => fifo_1_nReadyArray_0,
	validArray(0) => fifo_1_validArray_0,
	dataOutArray(0) => fifo_1_dataOutArray_0
);

fifo_6: entity work.transpFIFO(arch) generic map (1,1,32,32,3)
port map (
	clk => fifo_6_clk,
	rst => fifo_6_rst,
	dataInArray(0) => fifo_6_dataInArray_0,
	pValidArray(0) => fifo_6_pValidArray_0,
	readyArray(0) => fifo_6_readyArray_0,
	nReadyArray(0) => fifo_6_nReadyArray_0,
	validArray(0) => fifo_6_validArray_0,
	dataOutArray(0) => fifo_6_dataOutArray_0
);
