...
for.body:                                         ; preds = %for.inc21, %entry
  %sum.05 = phi i32 [ 0, %entry ], [ %add17, %for.inc21 ]
...
for.body14:                                       ; preds = %for.body14, %for.end
  ...
  %add17 = add nsw i32 %sum.13, %7
  %inc19 = add nuw nsw i32 %j.02, 1
  %cmp13 = icmp ult i32 %inc19, 99
  br i1 %cmp13, label %for.body14, label %for.inc21

for.inc21:                                        ; preds = %for.body14
  %inc22 = add nuw nsw i32 %t.04, 1
  %cmp = icmp ult i32 %inc22, 3
...
for.end14:                                        ; preds = %for.inc12
  ...
  %call21 = call i32 @_Z15jacobi_1d_imperPiS_(i32* nonnull %arraydecay, i32* nonnull %arraydecay20)
  ret i32 0
}
