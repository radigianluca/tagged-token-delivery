...
int fpl_buffer_matrix (in_int_t in_a[TOT_DIM], in_int_t in_b[TOT_DIM], out_int_t out_c[TOT_DIM])
{
    int i,j,k;
    for (i = 0; i < A_ROWS; i++)
    {
...
int main(void){
    ...
    int i = 0;
    fpl_buffer_matrix(in_a[i], in_b[i], out_c[i]);
}
